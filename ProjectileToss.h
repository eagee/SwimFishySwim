...
#ifndef TOSS_PROJECTILE_H
#define TOSS_PROJECTILE_H

#include "IProjectileWeapon.h"
#include "TiledMaps.h"

class ProjectileToss: public IProjectileWeapon
{
public:
		///<summary>
		/// Constructor...duh
		///</summary>			
		ProjectileToss(IModel *model, IAudio *upgradeSound, IAudio *downGradeSound, IAudio *shootingSound);
