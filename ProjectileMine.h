// ProjectileMine.h
// Defines implementation of IProjectileWeapon to shoot a Mine with varying behaviors
// Author(s): Eagan Rackley
#ifndef MINE_PROJECTILE_H
#define MINE_PROJECTILE_H

#include "IProjectileWeapon.h"
#include "TiledMaps.h"

class ProjectileMine: public IProjectileWeapon
{
public:
		///<summary>
		/// Constructor...duh
		///</summary>			
		ProjectileMine(IModel *model, IAudio *upgradeSound, IAudio *downGradeSound, IAudio *shootingSound);
