// ProjectileSpit.h
// Defines implementation of IProjectileWeapon to shoot at baddies with varying behaviors
// Author(s): Eagan Rackley
#ifndef SPIT_PROJECTILE_H
#define SPIT_PROJECTILE_H

#include "IProjectileWeapon.h"
#include "TiledMaps.h"

class ProjectileSpit: public IProjectileWeapon
{
public:
		///<summary>
		/// Constructor...duh
		///</summary>			
		ProjectileSpit(IModel *model, IAudio *upgradeSound, IAudio *downGradeSound, IAudio *shootingSound);
