...
#ifndef CONTROLLER_WIN_H
#define CONTROLLER_WIN_H
...
/// </summary>
class ControllerWin: public IControllers
{
public:
	...
	/// </summary>
	ControllerWin(int screenWidth, int screenHeight);
	
	/// <summary>
	/// This is the test subject object used to test the observer pattern
	/// </summary>	
	virtual ~ControllerWin();
...
private:
	...
	CONTROLLER_STATUS wiiMoteStatus[MAXIMUM_CONTROLLERS];		
};
