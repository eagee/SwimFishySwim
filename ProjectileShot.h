...
#ifndef SHOT_PROJECTILE_H
#define SHOT_PROJECTILE_H

#include "IProjectileWeapon.h"
#include "TiledMaps.h"

class ProjectileShot: public IProjectileWeapon
{
public:
		///<summary>
		/// Constructor...duh
		///</summary>			
		ProjectileShot(IModel *model, IAudio *upgradeSound, IAudio *downGradeSound, IAudio *shootingSound);
