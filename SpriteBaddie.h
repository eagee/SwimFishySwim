...
#ifndef BADDIE_SPRITE_H
#define BADDIE_SPRITE_H
...
///</summary>
class SpriteBaddie: public ISprite, public INodeWaypoints
{ 
	public:
		
		SpriteBaddie();
		
		virtual ~SpriteBaddie();
		...
		///</summary>													
		virtual void setControlMagnitude(float controlMagnitude);
	...
	private:
		...
		Vector myCurrentWaypoint;
		NodeWaypoints myNodeWaypoints;
};
